...
VALUES
  ...
  ('a1111112-1111-1111-1111-111111111111', 'Fresh Organic Tomatoes', 'Vine-ripened organic tomatoes, perfect for salads and cooking', 'https://upload.wikimedia.org/wikipedia/commons/8/89/Tomato_je.jpg', 'case', 19.99, 0.00, 120, 1, '11111111-1111-1111-1111-111111111111', 'Organic', now()),
...
VALUES
  ...
  -- Pending request
  ('b1111112-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'pending', now() - INTERVAL '3 days', NULL),
  -- Completed link (past relationship)
  ('b1111113-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'completed', now() - INTERVAL '30 days', now() - INTERVAL '29 days'),
  -- Rejected request
  ('b1111114-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'rejected', now() - INTERVAL '5 days', NULL),
