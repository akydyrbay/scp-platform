...
class NotificationService {
  ...
  Future<void> markAsRead(String notificationId) async {
    try {
      await _httpService.post('/consumer/notifications/$notificationId/read');
    } catch (e) {
  ...
  Future<void> markAllAsRead() async {
    try {
      await _httpService.post('/consumer/notifications/mark-all-read');
    } catch (e) {
  ...
  Future<void> showLocalNotification({
    ...
    const AndroidNotificationDetails androidDetails =
      ...
      'scp_notifications',
      'SCP Notifications',
      channelDescription: 'Notifications for SCP Consumer App',
