...
# Script to generate Android keystore for Supplier Sales App
...
KEYSTORE_FILE="$KEYSTORE_DIR/supplier-release-key.jks"
...
echo "🔑 Generating Android keystore for Supplier Sales App..."
