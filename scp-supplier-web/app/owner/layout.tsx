...
const navItems: SidebarItem[] = [
  ...
  { href: '/owner/team', label: 'Team Management', icon: 'team' },
  { href: '/owner/settings', label: 'Account Settings', icon: 'settings' }
]
        ...
        <div className='flex h-full flex-col gap-10 px-8 py-10'>
          <div>
            <p className='text-xs uppercase tracking-[0.4em] text-neutral-500'>Supplier Platform</p>
              <h1 className='mt-3 text-2xl font-semibold text-neutral-900'>{user?.name || 'Owner'}</h1>
